...
namespace MoeKinoWebApp.Migrations
{
    ...
    [Migration("20240801182034_CreateUserFavouriteMoviesTable")]
    partial class CreateUserFavouriteMoviesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoeKinoWebApp.Models.MovieParticipant", b =>
                {
                    b.Property<int>("MovieID")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MovieParticipantCategoryID")
                        .HasColumnType("int");

                    b.HasKey("MovieID", "PersonID", "MovieParticipantCategoryID");

                    b.HasIndex("MovieParticipantCategoryID");
            ...
            modelBuilder.Entity("MoeKinoWebApp.Models.Person", b =>
                {
                    ...
                    b.Property<string>("ShortBioEn")
                        .HasColumnType("nvarchar(MAX)");

                    b.Property<string>("ShortBioRu")
                        .HasColumnType("nvarchar(MAX)");
            ...
            modelBuilder.Entity("MoeKinoWebApp.Models.MovieParticipant", b =>
                {
                    ...
                    b.HasOne("MoeKinoWebApp.Models.MovieParticipantCategory", "MovieParticipantCategory")
                        .WithMany("MovieParticipants")
                        .HasForeignKey("MovieParticipantCategoryID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MoeKinoWebApp.Models.Person", "Person")
                        .WithMany("MovieParticipants")
                    ...
                    b.Navigation("MovieParticipantCategory");
